...
$order = array(
  ...
  'price_btc_in_satoshi'        => $_order['price_btc_in_satoshi'],
  'price_cny'                   => $_order['price_cny'],
  'price_cny_in_fen'            => $_order['price_cny_in_fen'],
  'pay_btc'                     => $_order['pay_btc'],
  'pay_btc_in_satoshi'          => $_order[''pay_btc_in_satoshi'],
